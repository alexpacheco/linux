...
\begin{frame}{\small Commands (contd)}
  \begin{bblock}{alias}
    \begin{itemize}
      ...
      \begin{itemize}
        {\scriptsize
          \item[$\vardiamond$] bash/sh/ksh: \texttt{alias <name>="<actual command>"}
          \item[$\vardiamond$] csh/tcsh: \texttt{alias <name> "<actual command>"}
        }
      \end{itemize}
...
\begin{frame}
  ...
  \begin{center}
    ...
    {\fontsize{15}{30}\selectfont
      \color{red!80!black}{Sep 18: HPC User Environment}\\
      \color{red!80!black}{Sep 25 \& Oct 2: Shell Scripting}\\
    }
    \vspace{0.5cm}
