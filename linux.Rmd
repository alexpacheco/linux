---
title: "Linux: Command & Environments"
...
* Linux is the most popular OS used in a Supercomputer<sup>a</sup>
...
<script id="asciicast-44JH2pHsDUgTOB7NVDtWtyCdH" src="https://asciinema.org/a/44JH2pHsDUgTOB7NVDtWtyCdH.js" async data-rows=25></script>
...
* Example: `rsync -avtzu sol.cc.lehigh.edu:∼/* .`
...
* __HOME__:  indicate where a user’s home directory is located in the file system.
...
* __USER__:  Current logged in user’s name
